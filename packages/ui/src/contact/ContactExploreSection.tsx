    ...
    <section className="py-16 bg-slate-50/80 border-t border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-primary-100 text-primary-800 uppercase tracking-wider mb-3">
            Explora & Atención
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {links.map((link) => (
            ...
            >
              <div>
                <div className="w-14 h-14 rounded-2xl bg-primary-50 text-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary-100 transition-all">
              ...
              <div>
                <a
                  ...
                  className="inline-flex items-center gap-2 text-xs font-bold text-primary-700 hover:text-primary-800 bg-primary-50 hover:bg-primary-100 px-4 py-2.5 rounded-xl transition-all w-full justify-center"
                >
