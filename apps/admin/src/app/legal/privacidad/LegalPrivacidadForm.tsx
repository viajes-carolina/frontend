...
export function LegalPrivacidadForm({ initialConfig }: LegalPrivacidadFormProps) {
  ...
  if (!config) {
    return (
      <FormFeedback feedback={{ tone: "error", message: error || "No se pudo cargar la política de privacidad." }} />
    );
  }
  ...
  return (
    <FormCard
      ...
      description="Ruta pública: /privacidad"
      feedback={feedback}
      onSubmit={handleSubmit}
      saving={saving}
      submitLabel="Guardar Política de privacidad"
    >
