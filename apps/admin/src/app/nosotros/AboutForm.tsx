...
import { Button, Disclosure, FormField, SaveBar, SectionRail, type SectionRailItem } from "@vc/ui";
...
const SECTION_DEFINITIONS: { id: string; label: string }[] = [
  { id: "cabecera", label: "Cabecera & Foto Principal" },
  { id: "historia", label: "Historia & Principios" },
  { id: "mision", label: 'Misión & Ruta "de idea a recuerdo"' },
  { id: "acompanamiento", label: "Cómo te acompañamos" },
  { id: "experiencias", label: "Experiencias que humanizan" },
  { id: "humano", label: "Una persona al otro lado" },
];
...
export function AboutForm() {
  ...
  // "modificado" se muestra en las 6 secciones mientras exista cualquier
      ...
      <div className="flex gap-8 pb-24">
        ...
        <div className="flex-1 min-w-0 max-w-4xl">
          ...
          {activeSection === "cabecera" && (
            <div role="tabpanel" id="panel-cabecera" aria-labelledby="tab-cabecera">
          ...
          {activeSection === "mision" && (
            <div role="tabpanel" id="panel-mision" aria-labelledby="tab-mision">
              <div className="bg-white border border-neutral-border shadow-sm rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          {activeSection === "acompanamiento" && (
            <div role="tabpanel" id="panel-acompanamiento" aria-labelledby="tab-acompanamiento">
              <div className="bg-white border border-neutral-border shadow-sm rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          {activeSection === "experiencias" && (
            <div role="tabpanel" id="panel-experiencias" aria-labelledby="tab-experiencias">
              <div className="bg-white border border-neutral-border shadow-sm rounded-2xl p-6 sm:p-8 space-y-6">
          ...
          {activeSection === "humano" && (
            <div role="tabpanel" id="panel-humano" aria-labelledby="tab-humano">
              <div className="bg-white border border-neutral-border shadow-sm rounded-2xl p-6 sm:p-8 space-y-6">
                <div>
