...
export function ContactSettingsForm({
  ...
  // "modificado" se muestra en las 2 secciones mientras exista cualquier
  ...
  return (
    <>
      <div>
        <h2 className="font-sora font-bold text-lg text-brand-navy">Configuración Editorial de Contacto</h2>
      ...
      <div className="flex gap-8 pb-24">
        ...
        <div className="flex-1 min-w-0 max-w-4xl">
          ...
          {activeSection === "hero" && (
            <div role="tabpanel" id="panel-hero" aria-labelledby="tab-hero">
              <div className="bg-white p-6 sm:p-8 rounded-2xl border border-neutral-border shadow-sm space-y-4">
          ...
          {activeSection === "oficina" && (
            <div role="tabpanel" id="panel-oficina" aria-labelledby="tab-oficina">
              <div className="bg-white p-6 sm:p-8 rounded-2xl border border-neutral-border shadow-sm space-y-4">
                <h3 className="font-sora font-semibold text-xs text-brand-navy uppercase tracking-wider">
                  2. Oficina & Mapa
                </h3>
